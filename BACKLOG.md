...
- [ ] **19 — Simple Score Tracking** · [spec](specs/19-simple-score-tracking.md) · Per-session toggle (default on) replaces Generate Matches + score form with a minimal winner/loser picker; records 21–15 internally
