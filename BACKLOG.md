...
- [ ] **13 — UI Tweaks** · [spec](specs/13-ui-tweaks.md) · Session stats show total match count; player detail groups results by session; leaderboard drops Skill Level column
