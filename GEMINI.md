...
# Gemini CLI Project Context — snobaddy

> This file is the Gemini CLI equivalent of `CLAUDE.md`. Both files must always be kept in sync.
> When making changes, update both files identically.
