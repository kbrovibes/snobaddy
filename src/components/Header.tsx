          ...
          <div className="absolute right-0 mt-2 w-44 bg-surface dark:bg-[#1A1A1A] border border-border-light dark:border-border rounded-xl shadow-lg dark:shadow-none dark:ring-1 dark:ring-border overflow-hidden">
            {playerId && (
              <NavLink
                ...
                className="flex items-center gap-2 px-4 py-1.5 text-sm text-text hover:bg-surface-alt transition-colors"
              >
            ...
            <button
              ...
              className="flex items-center gap-2 w-full px-4 py-1.5 text-sm text-text hover:bg-surface-alt transition-colors"
            >
            ...
            <button
              onClick={signOut}
              className="flex items-center gap-2 w-full px-4 py-1.5 text-sm text-red-500 dark:text-red-400 hover:bg-surface-alt transition-colors"
            >
              <span className="text-base">🚪</span>
              Logout
            </button>
