  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center px-4 h-14 bg-surface dark:bg-background">
      ...
      <NavLink href="/" className="flex flex-col items-center leading-tight">
        <span className="font-bold text-heading text-3xl tracking-tight">Serve Sports</span>
        <span className="font-black text-heading text-[15px] tracking-[0.25em] uppercase -mt-0.5">Badminton</span>
      </NavLink>
