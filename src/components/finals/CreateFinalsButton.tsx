  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <button
        ...
        disabled={loading}
        className="px-5 py-2.5 text-sm font-semibold text-stone-600 bg-white border border-stone-300 rounded-xl disabled:opacity-50 hover:bg-stone-50 hover:border-stone-400 transition-colors"
      >
