...
export default function UploadScoresButton({ sessionId }: { sessionId: string }) {
  ...
  return (
    <button
      ...
      className="w-full py-3 text-sm font-medium rounded-xl bg-rose-600 hover:bg-rose-700 dark:bg-rose-700 dark:hover:bg-rose-800 text-white transition-colors"
    >
      Finalize Session
    </button>
  );
