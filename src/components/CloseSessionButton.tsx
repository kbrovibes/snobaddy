...
export default function CloseSessionButton({ sessionId }: { sessionId: string }) {
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-xl px-4 py-3 flex flex-col gap-3">
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={handleClose}
            disabled={loading}
            className="flex-1 py-2 text-sm font-semibold text-white bg-blue-600 rounded-lg disabled:opacity-50"
          >
  ...
  return (
    <button
      ...
      className="w-full py-2.5 text-sm font-semibold text-white bg-blue-500 rounded-xl hover:bg-blue-600 transition-colors"
    >
