...
import { Plus_Jakarta_Sans, Geist_Mono, Righteous } from "next/font/google";
...
export default function RootLayout({
  ...
  return (
    <html
      ...
      className={`${plusJakartaSans.variable} ${geistMono.variable} ${righteous.variable} h-full antialiased`}
    >
      <head>
        <script
