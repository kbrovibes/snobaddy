...
- **Dark mode (Phase 1)** — App now defaults to dark mode. Toggle between Light / Dark / Auto from your player profile page. App shell (header, bottom nav, backgrounds) fully themed; remaining pages will be migrated in follow-up phases.
